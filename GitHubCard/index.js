...
*/
axios
.get('https://api.github.com/users/CherScot79')
.then((res) => {
  const info = res.data;
...
const followersArray = [
  "https://api.github.com/users/Tank921",
  "https://api.github.com/users/MileyWright",
  "https://api.github.com/users/duointherain",
